; ch04_01_dll_delete.asm — Build a doubly linked list, then delete the node at a
...
;
; Build:
;   nasm -f elf64 ch04_01_dll_delete.asm -o ch04_01_dll_delete_asm.o
;   gcc ch04_01_dll_delete_asm.o -o ch04_01_dll_delete_asm -no-pie
; Run:
;   ./ch04_01_dll_delete_asm
