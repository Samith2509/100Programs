; ch04_03_insert_position.asm — Build a doubly linked list, then insert a new node
...
;
; Build:
;   nasm -f elf64 ch04_03_insert_position.asm -o ch04_03_insert_position_asm.o
;   gcc ch04_03_insert_position_asm.o -o ch04_03_insert_position_asm -no-pie
; Run:
;   ./ch04_03_insert_position_asm
